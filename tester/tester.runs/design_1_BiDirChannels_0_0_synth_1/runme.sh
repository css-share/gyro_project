...
HD_PWD='C:/Xilinx/Vivado/projects/initial_gyro_tester_experiments/tester/tester.runs/design_1_BiDirChannels_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_BiDirChannels_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_BiDirChannels_0_0.tcl
