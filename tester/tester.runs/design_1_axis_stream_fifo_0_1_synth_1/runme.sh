...
HD_PWD='C:/Xilinx/Vivado/projects/initial_gyro_tester_experiments/tester/tester.runs/design_1_axis_stream_fifo_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axis_stream_fifo_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axis_stream_fifo_0_1.tcl
