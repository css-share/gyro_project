...
HD_PWD='C:/Xilinx/Vivado/projects/project_GYRO_Feb_04_2019/project_GYRO_Feb_04_2019.runs/design_1_axis_stream_fifo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axis_stream_fifo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axis_stream_fifo_0_0.tcl
